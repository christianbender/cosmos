	...
	public class Listen implements ActionListener {
		public void actionPerformed(ActionEvent ae) {
			if (ae.getSource() == toggle) {
				...
				int i_fill[] = { 4, 4, 5, 5, 2, 2, 3, 4, 5, 6, 7, 8, 8, 5, 3, 4, 5, 6, 5, 2, 3, 4, 2, 3, 4, 1, 5, 0, 1,
						5, 6, 2, 2, 3, 3, 7 };
				int j_fill[] = { 0, 1, 0, 1, 12, 13, 11, 10, 10, 10, 11, 12, 13, 14, 15, 16, 16, 16, 17, 20, 20, 20, 21,
						21, 21, 22, 22, 24, 24, 24, 24, 34, 35, 34, 35, 15 };
				int shift = 4;
				for (int i = 0; i < 36; i++) {
